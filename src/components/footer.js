...
import Logo from '../../static/logo/logo-footer.svg'
            ...
            <footer className="footer-section">
                <div className="footer-container footer-grid">
                    <div className="footer-child footer-paragraph-info">
                        ...
                        <p>
                            Arthur Grant loves to hear from readers. You can reach him via email.
                        ...
                        <nav className="social-media-nav">
                            <ul>
                                ...
                                <li>
                                    <a href="https://www.facebook.com/Arthur-Grant-103911168094946/"
                                        target="_blank"
                                        rel="noreferrer">
                                        <FontAwesomeIcon
                                ...
                                <li>
                                    <a
                                        target="_blank"
                                        href="https://www.goodreads.com/book/show/54901359-deven"
                                        rel="noreferrer"
                                    >
